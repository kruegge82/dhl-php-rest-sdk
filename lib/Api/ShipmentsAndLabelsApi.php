...
class ShipmentsAndLabelsApi
{
     ...
     * @throws \kruegge82\DHL\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\kruegge82\DHL\Model\RequestStatus|\kruegge82\DHL\Model\RequestStatus|\kruegge82\DHL\Model\RequestStatus
     */
     ...
     * @throws \kruegge82\DHL\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\kruegge82\DHL\Model\RequestStatus|\kruegge82\DHL\Model\RequestStatus|\kruegge82\DHL\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
