...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product' => '\kruegge82\DHL\Model\Product',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cost_center']) && (mb_strlen($this->container['cost_center']) > 50)) {
            $invalidProperties[] = "invalid value for 'cost_center', the character length must be smaller than or equal to 50.";
        }
     ...
     * Gets product
     *
     * @return \kruegge82\DHL\Model\Product|null
     */
     ...
     * Sets product
     *
     * @param \kruegge82\DHL\Model\Product|null $product product
     *
     * @return self
     */
    ...
    public function setCostCenter($cost_center)
    {
        ...
        if ((mb_strlen($cost_center) > 50)) {
            throw new \InvalidArgumentException('invalid length for $cost_center when calling Shipment., must be smaller than or equal to 50.');
        }
