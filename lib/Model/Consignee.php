...
class Consignee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['address_house']) && !preg_match("/^(?!0$).*$/", $this->container['address_house'])) {
            $invalidProperties[] = "invalid value for 'address_house', must be conform to the pattern /^(?!0$).*$/.";
        }
    ...
    public function setAddressHouse($address_house)
    {
        ...
        if ((!preg_match("/^(?!0$).*$/", ObjectSerializer::toString($address_house)))) {
            throw new \InvalidArgumentException("invalid value for \$address_house when calling Consignee., must conform to the pattern /^(?!0$).*$/.");
        }
     ...
     * Gets country
     *
     * @return \kruegge82\DHL\Model\Country
     */
     ...
     * Sets country
     *
     * @param \kruegge82\DHL\Model\Country $country country
     *
     * @return self
     */
