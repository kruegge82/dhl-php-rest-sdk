...
class ShipmentsAndLabelsApi
{
     ...
     * @return \kruegge82\DHL\Model\LabelDataResponse|\kruegge82\DHL\Model\RequestStatus
     */
    public function createOrders(
        \kruegge82\DHL\Model\ShipmentOrderRequest $shipment_order_request,
        ?string $accept_language = null,
        ?bool $validate = false,
        ?bool $must_encode = false,
        ?string $include_docs = 'include',
        ?string $doc_format = 'PDF',
        ?string $print_format = null,
        ?string $retoure_print_format = null,
        ?bool $combine = true,
        string $contentType = self::contentTypes['createOrders'][0]
    ): \kruegge82\DHL\Model\LabelDataResponse|\kruegge82\DHL\Model\RequestStatus
    {
     ...
     */
    public function createOrdersWithHttpInfo(
        \kruegge82\DHL\Model\ShipmentOrderRequest $shipment_order_request,
        ?string $accept_language = null,
        ?bool $validate = false,
        ?bool $must_encode = false,
     ...
     */
    public function createOrdersAsync(
        \kruegge82\DHL\Model\ShipmentOrderRequest $shipment_order_request,
        ?string $accept_language = null,
        ?bool $validate = false,
        ?bool $must_encode = false,
     ...
     * @return PromiseInterface
     */
    public function createOrdersAsyncWithHttpInfo(
        \kruegge82\DHL\Model\ShipmentOrderRequest $shipment_order_request,
        ?string $accept_language = null,
        ?bool $validate = false,
        ?bool $must_encode = false,
     ...
     */
    public function createOrdersRequest(
        \kruegge82\DHL\Model\ShipmentOrderRequest $shipment_order_request,
        ?string $accept_language = null,
        ?bool $validate = false,
        ?bool $must_encode = false,
     ...
     * @return array of \kruegge82\DHL\Model\LabelDataResponse|\kruegge82\DHL\Model\LabelDataResponse|\kruegge82\DHL\Model\LabelDataResponse|\kruegge82\DHL\Model\RequestStatus|\kruegge82\DHL\Model\RequestStatus|\kruegge82\DHL\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function ordersAccountDeleteWithHttpInfo(
        string $profile,
        string $shipment,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['ordersAccountDelete'][0]
     ...
     * @return PromiseInterface
     */
    public function ordersAccountDeleteAsync(
        string $profile,
        string $shipment,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['ordersAccountDelete'][0]
     ...
     * @return PromiseInterface
     */
    public function ordersAccountDeleteAsyncWithHttpInfo(
        string $profile,
        string $shipment,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['ordersAccountDelete'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersAccountDeleteRequest(
        string $profile,
        string $shipment,
        ?string $accept_language = null,
        string $contentType = self::contentTypes['ordersAccountDelete'][0]
