...
class ValidationMessageItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValidationMessageItem';
    ...
    */
     ...
     * @return $this
     */
    public function setValidationMessage(?string $validation_message): static
    {
     ...
     * @return $this
     */
    public function setValidationState(?string $validation_state): static
    {
